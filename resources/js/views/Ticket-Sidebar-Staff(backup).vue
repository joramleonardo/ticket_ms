        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <router-link to="/ticket/staff/status" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse_sciencejourno" aria-expanded="false" aria-controls="collapse_accountmanagement" exact>
                        <div class="sb-nav-link-icon">
                    ...
                    <div class="collapse" id="collapse_sciencejourno" aria-labelledby="headingOne" data-parent="#sidenavAccordion" >
                        <nav class="sb-sidenav-menu-nested nav">
                            <!-- <router-link to="/ticket/pending" class="nav-link" exact>
                                <div class="sb-nav-link-icon">
                            ...
                            <!-- <router-link to="/ticket/staff/closed" class="nav-link" exact>
                                <div class="sb-nav-link-icon">
                                    <i class="fas fa-circle" style="color: #343a40"></i>
                                </div>
                                Closed
                            </router-link> -->
                            <!-- <router-link to="/ticket/staff/rescheduled" class="nav-link" exact>
                                <div class="sb-nav-link-icon">
