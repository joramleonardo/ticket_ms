...
<div id="home-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#home-top">Home</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Submit a Request</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#track">Track</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 mb-0">
                                            <b-form-group class="group" id="form_RequestTypeOther">
                                                <label for="externalOtherType" class="label" style="color:black; font-weight: bold">If other enter Specific Request</label>
        ...
        <!-- Track Section-->
        <section class="page-section bg-secondary text-white mb-0" id="track">
            <div class="container">
                ...
                <div class="row">
                    <b-form class="loginn-form" v-on:submit.prevent="getTicketStatus">
                            ...
                            <b-form-group class="group">
                                <b-button type="submit" class="tab button" variant="outline-info" style="background: #2384b3 !important;">Track</b-button>
                            </b-form-group>
                    </b-form>
                </div>
            </div>
