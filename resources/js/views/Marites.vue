        ...
        <div class="ftco-section" style="height: 2080px;">
            <div class="login-wrap">
                <div class="login-html">
                    <h3 style="color:white">Management Access to Realtime Internal Tsismis Electronic System</h3>
                    <br>
                    <b-form-group class="group">
                        <label for="type" class="label" style="color: white">Select Type of Tsismis:<span style="font-style: italic; font-size: 10px; text-transform: none; color: white">  (Please select below... )</span></label>
                        <b-form-select v-model="ticketData.type" id="type" :options="drop_chismis_type"></b-form-select>
                    </b-form-group>
							...
							<div class="row">
								<div class="column">
									<!-- <b-form-group class="group">
										...
										<b-form-input v-model="ticketData.employee_code" id="employee_code" type="text" class="input" style="background: #fff; border: 1px solid #ced4da !important; color: black"></b-form-input>
									</b-form-group>
									<b-form-group class="group">
										<label for="type" class="label">Type <span style="font-style: italic; font-size: 10px; text-transform: none">  (Please select below... )</span></label>
										<b-form-select v-model="ticketData.type" id="type" :options="drop_type"></b-form-select>
									</b-form-group> -->
									<!-- <b-form-group class="group">
										<label for="hardware" class="label">Hardware <span style="font-style: italic; font-size: 10px; text-transform: none">  (Please select below... )</span></label>
										<b-form-select v-model="ticketData.hardware" id="hardware" :options="drop_hardware"></b-form-select>
									</b-form-group>
									<b-form-group class="group">
										<label for="software" class="label">Software <span style="font-style: italic; font-size: 10px; text-transform: none">  (Please select below... )</span></label>
										<b-form-select v-model="ticketData.software" id="software" :options="drop_software"></b-form-select>
									</b-form-group> -->
								</div>
								<div class="column">
									<!-- <b-form-group class="group">
										<label for="remarks" class="label">Remarks</label>
										<b-form-textarea v-model="ticketData.remarks" id="remarks" placeholder="Enter remarks here..." rows="11" max-rows="11" style="background: #fff !important; color: black"></b-form-textarea>
									</b-form-group> -->
								</div>
							</div>
                            <b-form-group class="group">
								<b-button type="submit" class="tab button" style="background-color: #1161ee !important;" variant="outline-success"	>SEARCH</b-button>
                            </b-form-group>
                        <!-- </div> -->
                            <!-- <div class="hr"></div> -->
...
export default {
    data() {
        return {
			...
			drop_chismis_type: [{ text: '(SELECT TYPE HERE)', value: null }, 	'Kabit', 
                                                                                'Bida Bida', 
                                                                                'LGP', 
                                                                                'Steph'],
